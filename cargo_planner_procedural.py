...
"""
!!!PROBLEM UNSOLVED!!! w opcji B, nie rozpoznaje paczek o tych samych długościach, po sortowaniu są obcięte
!!!PROBLEM UNSOLVED!!! w opcji A, po dwukrotnym wpisaniu błędnej nazwy text file ("data.txt"): ErrorException


SORTING TO CORRECT:
- if: szer > dł = replace each other szer=dł & dł=szer
- w: porównanie wg. długości: zrobić podział: dł <= 200 = mniejsza tolerancja np do 50cm, dł > 200 = większa tolerancja np do 100cm
- nowy moduł: pozostałości poniżej 80 cm (zmienić pary w grupy wielokrotne)
"""
